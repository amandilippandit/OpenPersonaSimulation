...
from openpersona import config
...
class PersonaValidator:
    ...
    def validate_person(person, expectations=None, include_agent_spec=True, max_content_length=default_max_content_display_length) -> tuple[float, str]:
        """
        Validate a Persona instance using OpenAI's LLM.

        This method sends a series of questions to the Persona instance to validate its responses using OpenAI's LLM.
        ...
        Args:
            person (Persona): The Persona instance to be validated.
