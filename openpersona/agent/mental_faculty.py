from openpersona.agent import logger
...
import openpersona.agent as agent
...
class MentalFaculty(JsonSerializableRegistry):
    """
    ...
    def __eq__(self, other):
        if isinstance(other, MentalFaculty):
...
class CustomMentalFaculty(MentalFaculty):
    """
...
class RecallFaculty(MentalFaculty):
...
class FilesAndWebGroundingFaculty(MentalFaculty):
    """
...
class ToolUseFaculty(MentalFaculty):
    """
