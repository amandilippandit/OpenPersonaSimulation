"""
This module provides the main classes and functions for OpenPersona's  agents.

Agents are the key abstraction used in OpenPersona. An agent is a simulated person or entity that can interact with other agents and the environment, by
...
provide support for AI-based assistants or other such productivity tools, **OpenPersona agents aim at representing human-like behavior**, which includes
...
Self = TypeVar("Self", bound="Persona")
