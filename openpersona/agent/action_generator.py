...
from openpersona.validation import propositions
...
class ActionGenerator(JsonSerializableRegistry):
    ...
    def _generate_tentative_action(
        ...
        from openpersona.agent import (  # import here to avoid circular import issues
        ...
        if not self.enable_reasoning_step:
            ...
            if has_multimodal:
                from openpersona import config_manager as _cm
    ...
    def _inject_multimodal_images(agent, messages: list) -> None:
        ...
        """
        from openpersona.utils.media import build_multimodal_content_array
        from openpersona import config_manager as _cm
