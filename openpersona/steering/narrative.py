...
class Narrative:
    """
    Every simulation tells a story. This class provides helper mechanisms to help with crafting appropriate stories in OpenPersona.
    """
    ...
    def __init__(
        ...
        Args:
            environment (World, optional): The environment in which the story takes place. Defaults to None.
            agent (Persona, optional): The agent in the story. Defaults to None.
