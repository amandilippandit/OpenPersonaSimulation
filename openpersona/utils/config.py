...
def _ensure_log_file_path():
    ...
    if _log_file_path is None:
        ...
        _log_file_path = Path.cwd() / f"openpersona.{timestamp}.log"
...
def _apply_logging_levels():
    ...
    project_logger = logging.getLogger("openpersona")
...
def pretty_print_config(config):
    print()
    print("=================================")
    print("Current OpenPersona configuration ")
    print("=================================")
...
def pretty_print_openpersona_version():
    try:
        import importlib.metadata

        version = importlib.metadata.version("openpersona")
    except Exception:
        version = "unknown"
    print(f"OpenPersona version: {version}")
...
def start_logger(config: configparser.ConfigParser):
    ...
    project_logger.debug("OpenPersona logging initialized")
...
def get_log_file_path():
    """Return the path of the OpenPersona log file, if initialized."""
    return _log_file_path
