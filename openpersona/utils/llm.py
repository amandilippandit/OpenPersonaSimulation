...
from openpersona.utils import logger
from openpersona.utils.rendering import break_text_at_length
...
class LLMChat:
    ...
    def call(
        ...
        **rendering_configs,
        ...
        """
        from openpersona.clients import client  # import here to avoid circular import
        ...
        def wrapper(*args, **kwargs):
            for i in range(retries):
                try:
                    ...
                    try:
                        from openpersona.clients import client as _client
...
def add_rai_template_variables_if_enabled(template_variables: dict) -> dict:
    ...
    from openpersona import config  # avoids circular import
