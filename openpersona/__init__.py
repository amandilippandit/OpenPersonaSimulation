...
sys.path.append(".")
from openpersona import utils  # now we can import our utils

# AI disclaimers
print(
    """
!!!!
DISCLAIMER: OpenPersona relies on Artificial Intelligence (AI) models to generate content. 
...
config = utils.read_config_file()
utils.pretty_print_openpersona_version()
