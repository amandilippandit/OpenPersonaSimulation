"""
Some examples of how to use the openpersona library. These can be used directly or slightly modified to create your own '
agents.
"""
import os
...
def create_oscar_the_architect():
  return Persona.load_specification(load_example_agent_specification("Oscar"))
...
def create_lisa_the_data_scientist():
  return Persona.load_specification(load_example_agent_specification("Lisa"))
...
def create_lisa_the_data_scientist_2():
  ...
  lisa.define("occupation", {
                ...
                "description":
                """
                You are a data scientist. You work at Nexus Corp, in the M365 Search team. Your main role is to analyze 
...
def create_marcos_the_physician():
  return Persona.load_specification(load_example_agent_specification("Marcos"))
...
def create_lila_the_linguist():
  return Persona.load_specification(load_example_agent_specification("Lila"))
