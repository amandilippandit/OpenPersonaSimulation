...
This module provides various utilities to help you extract data from OpenPersona elements, such as agents and worlds. It also provides a 
mechanism to reduce the extracted data to a more concise form, and to export artifacts from OpenPersona elements. Incidentaly, it showcases 
...
# Exposed API
###########################################################################
from openpersona.extraction.artifact_exporter import ArtifactExporter
from openpersona.extraction.normalizer import Normalizer
