...
class ResultsExtractor:
    ...
    def extract_results_from_agents(
        ...
        """
        Extracts results from a list of Persona instances.

        Args:
            agents (List[Persona]): The list of Persona instances to extract results from.
    ...
    def extract_results_from_agent(
        ...
        """
        Extracts results from a Persona instance.

        Args:
            tinyperson (Persona): The Persona instance to extract results from.
            extraction_objective (str): The extraction objective.
            situation (str): The situation to consider.
            fields (list, optional): The fields to extract. If None, the extractor will decide what names to use.
                Defaults to None.
...
"""
    ...
    def extract_results_from_world(
        ...
        """
        Extracts results from a World instance.

        Args:
            tinyworld (World): The World instance to extract results from.
            extraction_objective (str): The extraction objective.
            situation (str): The situation to consider.
            fields (list, optional): The fields to extract. If None, the extractor will decide what names to use.
                Defaults to None.
